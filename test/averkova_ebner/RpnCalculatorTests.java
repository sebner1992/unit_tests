...
public class RpnCalculatorTests {
	...
	public void testArithmeticOperations() {
		CalculatorIO[] io = {new CalculatorIO (68.0, new String[]{"70", "2", "-"}),
	...
	public void divisionByZeroShouldThrowException() {
		...
		assertEquals("ERROR! Division by zero! Program terminated.", 
	...
	public void oneNullOrEmptyArgumentShouldThrowException() {
		...
		for(String[] inp : input) {
			...
			assertEquals("ERROR! The argument"+"\""+inp[0]+"\" is null or empty.", 
					exception.getMessage());
		}
	}
